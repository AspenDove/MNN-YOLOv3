...
public:
    ...
    int detect(cv::Mat &img, std::vector<FaceInfo> &face_list)const;

    void generateBBox(std::vector<FaceInfo> &bbox_collection, MNN::Tensor *scores, MNN::Tensor *boxes, cv::Size size)const;
