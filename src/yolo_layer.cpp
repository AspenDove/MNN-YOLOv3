...
//yolov3
float biases[18] = {6, 12, 15, 38, 36, 58, 24, 103, 49, 158, 66, 290, 139, 183, 112, 425, 226, 515};
...
detection *get_network_boxes(std::vector<layer> layers_params, int img_w, int img_h, int net_w, int net_h, float thresh, float hier, int *map, int relative, int *num)
{
    //make network boxes
